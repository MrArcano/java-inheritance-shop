...
//        cart[0] = new Smartphone("GalaxyS24","Samsung", new BigDecimal("100"),new BigDecimal("0.20"),123456789123456L,33);
//        cart[1] = new Television("MyTelevision69","MarcaCavallo", new BigDecimal("100"),new BigDecimal("0.20"),new BigDecimal("48"),true);
//        cart[2] = new Headphones("Syneizer","MarcaCavallo", new BigDecimal("100"),new BigDecimal("0.20"),"Red",true);


        Scanner scan = new Scanner(System.in);
        System.out.print("Hai la tessera: ");
        boolean card = Boolean.parseBoolean(scan.nextLine());
        ...
        for (Product product : cart) {
            System.out.println(product.getName() + " - PriceDiscount: " + product.getFullPrice(card) + " - Price: " + product.getFullPrice());
        }
